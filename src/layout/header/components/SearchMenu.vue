<template>
	<div class="layout-search-dialog">
		...
		<el-dialog v-model="isShowSearch" width="300px" top="100px" destroy-on-close :show-close="false">
			<el-autocomplete
				...
				@select="($event: unknown) => handleClickMenu($event as Menu.MenuOptions)"
			>
				<template #prefix>
					<el-icon>
						<Search />
...
const menuInputRef = ref<HTMLInputElement>();
